declare class Serial {
  ...
  public write(msg: string | ArrayBuffer): void
  public write(msg: string | ArrayBuffer, from: number): void
  public write(msg: string | ArrayBuffer, from: number, to: number): void
