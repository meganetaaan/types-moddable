  ...
  export class Poco extends Render {
    ...
    public constructor(
      ...
      dictionary: {
        ...
        fillRectangle(color: ColorCellOut, x: number, y: number, width: number, height: number): void
        blendRectangle(color: ColorCellOut, blend: number, x: number, y: number, width: number, height: number): void
        ...
        drawText(text: string, font: BMFont, color: Color, x: number, y: number, width?: number): void
